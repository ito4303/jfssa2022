...
```{r occ_jags_summary, echo=TRUE, comment="", prompt=TRUE}
...
parametersブロックとtranformed parametersブロック
...
```{r occ_stan, cache=TRUE, messages=FALSE, results='hide'}
...
<!-- chunk option echo=m:n does not work -->
...
```{r occ_stan_summary, echo=TRUE, comment="", prompt=TRUE}
...
```{r nmix_jags_summary, echo=TRUE, comment="", prompt=TRUE}
...
```{r nmix_results, echo=TRUE, comment="", prompt=TRUE}
...
```{r nmix_stan, cache=TRUE, messages=FALSE, results='hide'}
...
```{r nmix_stan_results, echo=TRUE, comment="", prompt=TRUE}
