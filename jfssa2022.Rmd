...
cat(occ_stan_model[1:14], sep = '\n')
```

---

```{r occ_stan_model2}
cat(occ_stan_model[16:27], sep = '\n')
```

---

```{r occ_stan_model3}
cat(occ_stan_model[29:38], sep = '\n')
```

---

```{r occ_stan_model4}
cat(occ_stan_model[40:52], sep = '\n')
```
...
```{r nmix_stan_model4}
cat(nmix_stan_model[28:31], sep = '\n')
```

---

```{r nmix_stan_model5}
cat(nmix_stan_model[33:40], sep = '\n')
```
